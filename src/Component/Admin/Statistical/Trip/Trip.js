      ...
      <div className="money">
          ...
          <div className="money__body">
              ...
              <Column
                ...
                />
                 <h1 style={{textAlign : 'center' , marginTop:'20px'}}>Biểu đồ thông kê số lượng chuyến xe của { textSelect === 'all' ? 'tất cả tuyến' : `tuyến ${select}`} { textStart === textEnd ? `vào năm ${textStart}` :  `từ năm ${textStart} đến năm ${textEnd}`}</h1>
          </div>
      </div>
  );
};
